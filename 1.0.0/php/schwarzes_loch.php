...
black-hole, black-hole:after, black-hole:before {
    display:block;
    border-radius:50%
}
...
black-hole {
    width:50vmin;
    height:51vmin;
    box-shadow:1vmin 0 3vmin 2vmin #f50,inset -1vmin 0 3vmin 4vmin #f80,-4vmin 0 35vmin 0 #f60;
...
black-hole:after, black-hole:before {
    content:"";
    background:#fff;
    position:relative;
    top:6vmin;
...
black-hole:before {
    ...
    height:3vmin;
    left:40vmin;
    box-shadow:#ff0 0 0 2vmin 2vmin, #ff0 2vmin 4vmin 2vmin .5vmin;
}
