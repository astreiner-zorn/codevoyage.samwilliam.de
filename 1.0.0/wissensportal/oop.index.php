...
<?php echo $section_beginn; ?>
<a href="/acp/wissensportal/oop.edit.php?id=<?php echo $oop_snippet['id']; ?>">Bearbeiten</a>
| <a href="/acp/wissensportal/oop.delete.php?id=<?php echo $oop_snippet['id']; ?>">Löschen</a>
<?php echo $section_ende; ?>
<?php endif; ?>
