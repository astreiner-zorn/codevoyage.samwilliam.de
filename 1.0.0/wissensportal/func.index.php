...
<?php
    ...
    if ($snippetName === '') {
        echo $section_beginn . "Snippet nicht gefunden oder keine Übereinstimmung" . $section_ende;
...
|
<a href="/acp/wissensportal/delete.php?id=<?php echo $snippet['id']; ?>">Löschen</a>
<?php echo $section_ende; ?>
<?php else: ?>
<?php
    echo $section_beginn . "Snippet nicht gefunden oder keine Übereinstimmung" . $section_ende;
