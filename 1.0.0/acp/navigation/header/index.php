...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        if (!empty($_POST['url']) && !empty($_POST['ziel']) && !empty($_POST['reihenfolge'])) {
            ...
            header("Location: /acp/navigation/header/index.php");
            exit();
        } else {
...
<table>
    ...
    <tr>
        ...
        <td>
            <a
                href="/acp/navigation/header/edit.php?id=<?php echo htmlspecialchars($row['ID']); ?>">Bearbeiten</a>
            |
            <a href="/acp/navigation/header/delete.php?id=<?php echo htmlspecialchars($row['ID']); ?>"
