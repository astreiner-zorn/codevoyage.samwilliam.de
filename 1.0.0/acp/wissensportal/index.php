...
<div class="ActionArea">
    <ul>
        <li><button class="button-action"><a href="/acp/wissensportal/add.php">Snippet hinzufügen</a></button>
        </li>
        <li><button class="button-action"><a href="/acp/wissensportal/oop.add.php">OOP-Snippet
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="<?php echo '/wissensportal/index.php?snippet=' . htmlspecialchars($snippet['url']); ?>"
                    target="_blank"><?php echo htmlspecialchars($snippet['title']); ?></a></td>
            <td><?php echo htmlspecialchars($snippet['description']); ?></td>
            <td>
                <a
                    href="/acp/wissensportal/edit.php?id=<?php echo $snippet['wissensportal_id']; ?>">Bearbeiten</a>
                |
                <a href="/acp/wissensportal/delete.php?id=<?php echo $snippet['wissensportal_id']; ?>"
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <a
                    href="/acp/wissensportal/acp/edit.php?id=<?php echo $snippet['wissensportal_id']; ?>">Bearbeiten</a>
                |
                <a href="/acp/wissensportal/delete.php?id=<?php echo $snippet['wissensportal_id']; ?>"
                    onclick="return confirm('Sicher, dass du dieses Snippet löschen willst?');">Löschen</a>
            </td>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($snippet['description']); ?></td>
            <td>
                <a href="/acp/wissensportal/edit.php?id=<?php echo $snippet['id']; ?>">Bearbeiten</a>
                |
                <a href="/acp/wissensportal/delete.php?id=<?php echo $snippet['id']; ?>"
                    onclick="return confirm('Sicher, dass du dieses Snippet löschen willst?');">Löschen</a>
            </td>
        </tr>
        <?php endforeach; ?>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="<?php echo '../wissensportal/index.php?oop_snippet=' . htmlspecialchars($snippet['url']); ?>"
                    target="_blank"><?php echo htmlspecialchars($snippet['title']); ?></a></td>
            <td>
                <a href="/acp/wissensportal/oop_edit.php?id=<?php echo $snippet['id']; ?>">Bearbeiten</a>
                |
                <a href="/acp/wissensportal/oop_delete.php?id=<?php echo $snippet['id']; ?>"
                    onclick="return confirm('Sicher, dass du dieses Snippet löschen willst?');">Löschen</a>
            </td>
        </tr>
        <?php endforeach; ?>
