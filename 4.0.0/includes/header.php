...
<head>
    ...
    @font-face {
        font-family: 'Roboto';
        src: url('https://utensils.samwilliam.de/fonts/roboto/Roboto-Regular.ttf') format('ttf');
        font-weight: 400;
        font-style: normal;
    }
...
<body class="bg-primary-subtle p-0 m-0 d-flex flex-column vh-100 fs-6" style="font-family: 'Roboto', sans-serif;">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Linke Seitenleiste -->
            <div class="col-md-3">
                <?php require_once($_SERVER['DOCUMENT_ROOT'] . "/includes/sidebarLeft.php"); ?>
            </div>
            ...
            <div class="col-md-9">
                ...
                <?php else: ?>
                <div id="siteContent"
                    class="bg-white p-3 rounded-3 mt-3 mb-3 border border-primary-subtle container shadow-sm">
