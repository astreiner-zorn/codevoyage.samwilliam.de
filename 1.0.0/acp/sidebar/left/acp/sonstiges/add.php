<?php
    ...
    $pageTitle = "Menüpunkt hinzufügen (Sonstiges)";
    require_once ($_SERVER['DOCUMENT_ROOT'] . "/layout/header/header.inc.php");

$sql = "
CREATE TABLE IF NOT EXISTS `acp_sidebar_left_sonstiges`
(
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        if (!empty($_POST['url']) && !empty($_POST['ziel'])) {
            ...
            $prepare = $connection->prepare('INSERT INTO `acp_sidebar_left_sonstiges` (`url`, `ziel`) VALUES (:url, :ziel)');
